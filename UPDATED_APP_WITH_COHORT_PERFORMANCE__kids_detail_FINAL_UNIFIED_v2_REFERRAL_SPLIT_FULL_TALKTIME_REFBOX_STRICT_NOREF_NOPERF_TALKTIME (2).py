...
try:
    ...
    if _master_for_tt == "Marketing" and _view_for_tt == "Talk Time" and _view_for_tt in ['Referrals', 'HubSpot Deal Score tracker', 'Marketing Lead Performance & Requirement', 'Kids detail', 'Deal Detail', 'Sales Intern Funnel', 'Master analysis', 'Referral Tracking', 'Talk Time']:
        try:
...
try:
    ...
    if _master_for_rb == "Marketing" and _view_for_rb == "Referral Box" and _view_for_rb in ['Referrals', 'HubSpot Deal Score tracker', 'Marketing Lead Performance & Requirement', 'Kids detail', 'Deal Detail', 'Sales Intern Funnel', 'Master analysis', 'Referral Tracking', 'Talk Time']
        _render_marketing_referral_box(
            ...
            source_col=source_col if 'source_col' in globals() else "Referred Intent Source",
